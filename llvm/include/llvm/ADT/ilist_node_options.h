...
template <class ParentTy> struct is_valid_option<ilist_node_parent<ParentTy>> : std::true_type {};
...
struct node_options {
  ...
  typedef ilist_node_base<enable_sentinel_tracking, parent_ptr_ty> node_base_type;
