...
using InstListType = SymbolTableList<Instruction, ilist_iterator_bits<true>, ilist_node_parent<BasicBlock>>;
    InstListType::iterator InsertAt;
public:
    InsertPosition(std::nullopt_t) : InsertAt() {}
    InsertPosition(std::nullptr_t) : InsertAt() {}
    // LLVM_DEPRECATED("Use BasicBlock::iterators for insertion instead", "BasicBlock::iterator")
...
private:
  friend class SymbolTableListTraits<Instruction, ilist_iterator_bits<true>, ilist_node_parent<BasicBlock>>;
