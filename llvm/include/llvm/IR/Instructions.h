...
public:
  StoreInst(Value *Val, Value *Ptr, InsertPosition InsertBefore = nullptr);
  inline StoreInst(Value *Val, Value *Ptr, Instruction *InsertBefore) : StoreInst(Val, Ptr, InsertPosition(InsertBefore)) {}
  StoreInst(Value *Val, Value *Ptr, bool isVolatile, InsertPosition InsertBefore = nullptr);
...
public:
  ...
  ICmpInst(
    InsertPosition InsertBefore,  ///< Where to insert
...
class BranchInst : public Instruction {
  ...
  explicit BranchInst(BasicBlock *IfTrue, InsertPosition InsertBefore = nullptr);
...
class IndirectBrInst : public Instruction {
  ...
  IndirectBrInst(Value *Address, unsigned NumDests, InsertPosition InsertBefore = nullptr);
...
class CatchReturnInst : public Instruction {
  ...
  CatchReturnInst(Value *CatchPad, BasicBlock *BB, InsertPosition InsertBefore = nullptr);
...
public:
  explicit UnreachableInst(LLVMContext &C, InsertPosition InsertBefore = nullptr);
...
public:
  ...
  TruncInst(
    ...
    InsertPosition InsertBefore = nullptr ///< Where to insert the new instruction
  );
