...
TEST_F(DILocationTest, Merge) {
  ...
  // in the same inlined-at function at different line and column.
  {
    ...
    ASSERT_NE(DebugLoc(), M->getInlinedAt());
...

  {
    ...
    auto A = DebugLoc::get(Context, 2, 7, N);
    auto M1 = DebugLoc::getMergedLocation(A, DebugLoc());
    ASSERT_NE(DebugLoc(), M1);
    EXPECT_EQ(2u, M1->getLine());
    EXPECT_EQ(7u, M1->getColumn());
    EXPECT_EQ(N, M1->getScope());

    auto M2 = DebugLoc::getMergedLocation(DebugLoc(), A);
    ASSERT_NE(DebugLoc(), M2);
...
#define EXPECT_ATOM(Loc, Group, Rank)                                          \
  ...
  {
    auto A = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 1,
                              /*AtomRank*/ 1);
    auto B = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 1,
                              /*AtomRank*/ 1);
    auto M = DebugLoc::getMergedLocation(A, B);
  ...
  // rank.
  {
    ...
    A = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 1,
                        /*AtomRank*/ 0);
    B = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 1,
                        /*AtomRank*/ 2);
  ...
  // nonzero rank.
  {
    auto A = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 1,
                              /*AtomRank*/ 1);
    auto B = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 2,
                              /*AtomRank*/ 2);
    auto M = DebugLoc::getMergedLocation(A, B);
    EXPECT_ATOM(M, 1u, 1u);
    EXPECT_EQ(M, DebugLoc::getMergedLocation(B, A));
    ...
    A = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 1,
                        /*AtomRank*/ 0);
    B = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 2,
                        /*AtomRank*/ 2);
    M = DebugLoc::getMergedLocation(A, B);
  ...
  // group (arbitrary choice for deterministic behaviour).
  {
    ...
    A = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 0,
                        /*AtomRank*/ 1);
    B = DebugLoc::get(Context, 2, 7, N, DebugLoc(), false, /*AtomGroup*/ 2,
                        /*AtomRank*/ 1);
    M = DebugLoc::getMergedLocation(A, B);
  ...
  // Completely different except same atom numbers. Zero out the atoms.
  {
    ...
    auto A = DebugLoc::get(Context, 1, 6, S, I, false, /*AtomGroup*/ 1,
                              /*AtomRank*/ 1);
    auto B = DebugLoc::get(Context, 2, 7, getSubprogram(), DebugLoc(), false,
...
TEST_F(DILocationTest, getDistinct) {
  ...
  DebugLoc L0 = DebugLoc::getDistinct(Context, 2, 7, N);
  EXPECT_TRUE(L0->isDistinct());
  DebugLoc L1 = DebugLoc::get(Context, 2, 7, N);
  EXPECT_FALSE(L1->isDistinct());
  EXPECT_EQ(L1, DebugLoc::get(Context, 2, 7, N));
}
...
TEST_F(DILocationTest, KeyInstructions) {
  ...
  DebugLoc A1 =
      DebugLoc::get(Context, 1, 0, getSubprogram(), DebugLoc(), false, 1, 2);
  ...
  DebugLoc::get(Context, 2, 0, getSubprogram(), DebugLoc(), false, 5, 1);
  EXPECT_EQ(Context.pImpl->NextAtomGroup, 6u);

  // The waterline should be unchanged (group <= next).
  DebugLoc::get(Context, 3, 0, getSubprogram(), DebugLoc(), false, 4, 1);
  EXPECT_EQ(Context.pImpl->NextAtomGroup, 6u);
  DebugLoc::get(Context, 3, 0, getSubprogram(), DebugLoc(), false, 5, 1);
  EXPECT_EQ(Context.pImpl->NextAtomGroup, 6u);
...
TEST_F(DebugVariableTest, DenseMap) {
  ...
  DebugVariable DebugVariableA(VarA, std::nullopt, DebugLoc());
  DebugVariable DebugVariableInlineA(VarA, std::nullopt, InlinedLoc);
  DebugVariable DebugVariableB(VarB, std::nullopt, DebugLoc());
  DebugVariable DebugVariableFragB(VarB, {{16, 16}}, DebugLoc());
