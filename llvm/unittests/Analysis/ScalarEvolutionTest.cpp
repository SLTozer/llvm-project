...
TEST_F(ScalarEvolutionsTest, SCEVAddRecFromPHIwithLargeConstants) {
  ...
  auto *Phi = PHINode::Create(Type::getInt64Ty(Context), 2, "", Br->getIterator());
  auto *Shl = BinaryOperator::CreateShl(Phi, Int64_32, "", Br->getIterator());
  auto *AShr = BinaryOperator::CreateExactAShr(Shl, Int64_32, "", Br->getIterator());
...
TEST_F(ScalarEvolutionsTest, SCEVAddRecFromPHIwithLargeConstantAccum) {
  ...
  auto *AShr = BinaryOperator::CreateExactAShr(Shl, Int32_16, "", Br->getIterator());
