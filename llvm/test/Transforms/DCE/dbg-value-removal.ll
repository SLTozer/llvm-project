...
; RUN: opt < %s -S -passes=redundant-dbg-inst-elim | FileCheck %s -check-prefixes=CHECK,OLDDBG-CHECK
; RUN: opt < %s -S -passes=redundant-dbg-inst-elim --try-experimental-debuginfo-iterators | FileCheck %s -check-prefixes=CHECK,NEWDBG-CHECK
...
; CHECK:       bb0:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 13, metadata !13, metadata !DIExpression()), !dbg !16
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 14, metadata !14, metadata !DIExpression()), !dbg !18
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 13, metadata !13, metadata !DIExpression()), !dbg !18
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 12, metadata !12, metadata !DIExpression()), !dbg !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 13, !13, !DIExpression(), !16
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 14, !14, !DIExpression(), !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 13, !13, !DIExpression(), !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 12, !12, !DIExpression(), !18
; CHECK-NEXT:    br label [[BB1:%.*]]
; CHECK:       bb1:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[A1:%.*]], metadata !14, metadata !DIExpression()), !dbg !18
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 888, metadata !13, metadata !DIExpression()), !dbg !18
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[A2:%.*]], metadata !12, metadata !DIExpression()), !dbg !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[A1:%.*]], !14, !DIExpression(), !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 888, !13, !DIExpression(), !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[A2:%.*]], !12, !DIExpression(), !18
; CHECK-NEXT:    [[T1:%.*]] = call i16 @bar(i16 0)
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[T1]], metadata !13, metadata !DIExpression()), !dbg !18
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[A2]], metadata !12, metadata !DIExpression(DW_OP_constu, 2, DW_OP_shr, DW_OP_stack_value)), !dbg !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[T1]], !13, !DIExpression(), !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[A2]], !12, !DIExpression(DW_OP_constu, 2, DW_OP_shr, DW_OP_stack_value), !18
; CHECK-NEXT:    br label [[BB2:%.*]]
; CHECK:       bb2:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[A1]], metadata !13, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 8)), !dbg !18
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[A1]], metadata !13, metadata !DIExpression(DW_OP_LLVM_fragment, 8, 8)), !dbg !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[A1]], !13, !DIExpression(DW_OP_LLVM_fragment, 0, 8), !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[A1]], !13, !DIExpression(DW_OP_LLVM_fragment, 8, 8), !18
; CHECK-NEXT:    [[T2:%.*]] = call i16 @bar(i16 [[T1]])
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[T2]], metadata !13, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 8)), !dbg !18
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[A1]], metadata !13, metadata !DIExpression(DW_OP_LLVM_fragment, 8, 8)), !dbg !19
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[T2]], !13, !DIExpression(DW_OP_LLVM_fragment, 0, 8), !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[A1]], !13, !DIExpression(DW_OP_LLVM_fragment, 8, 8), !19
; CHECK-NEXT:    br label [[BB3:%.*]]
; CHECK:       bb3:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[A1]], metadata !13, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 8)), !dbg !19
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i16 [[A1]], metadata !13, metadata !DIExpression()), !dbg !18
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[A1]], !13, !DIExpression(DW_OP_LLVM_fragment, 0, 8), !19
; NEWDBG-CHECK-NEXT:    #dbg_value { i16 [[A1]], !13, !DIExpression(), !18
