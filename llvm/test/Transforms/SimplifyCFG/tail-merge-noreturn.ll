...
; RUN: opt -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=1 -sink-common-insts  -S < %s | FileCheck %s -check-prefixes=CHECK,OLDDBG-CHECK
; RUN: opt -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=1 -sink-common-insts  -S < %s --try-experimental-debuginfo-iterators | FileCheck %s -check-prefixes=CHECK,NEWDBG-CHECK
...
; CHECK-NEXT:  entry:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[C:%.*]], metadata [[META5:![0-9]+]], metadata !DIExpression()), !dbg [[DBG7:![0-9]+]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[C:%.*]], [[META5:![0-9]+]], !DIExpression(), [[DBG7:![0-9]+]]
; CHECK-NEXT:    switch i32 [[C]], label [[SW_EPILOG:%.*]] [
; CHECK-NEXT:    i32 13, label [[SW_BB:%.*]]
; CHECK-NEXT:    i32 42, label [[SW_BB1:%.*]]
; CHECK-NEXT:    ]
; CHECK:       sw.bb:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 55, metadata [[META5]], metadata !DIExpression()), !dbg [[DBG7]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 55, [[META5]], !DIExpression(), [[DBG7]]
; CHECK-NEXT:    tail call void @abort()
; CHECK-NEXT:    unreachable
; CHECK:       sw.bb1:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 67, metadata [[META5]], metadata !DIExpression()), !dbg [[DBG7]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 67, [[META5]], !DIExpression(), [[DBG7]]
; CHECK-NEXT:    tail call void @abort()
; CHECK-NEXT:    unreachable
; CHECK:       sw.epilog:
; CHECK-NEXT:    ret void
...
; CHECK-NEXT:  entry:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[C:%.*]], metadata [[META5]], metadata !DIExpression()), !dbg [[DBG7]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[C:%.*]], [[META5]], !DIExpression(), [[DBG7]]
; CHECK-NEXT:    switch i32 [[C]], label [[SW_EPILOG:%.*]] [
; CHECK-NEXT:    i32 13, label [[SW_BB:%.*]]
; CHECK-NEXT:    i32 42, label [[SW_BB1:%.*]]
...
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[C_1]], metadata [[META5]], metadata !DIExpression()), !dbg [[DBG7]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[C_1]], [[META5]], !DIExpression(), [[DBG7]]
; CHECK-NEXT:    tail call void @abort()
; CHECK-NEXT:    unreachable
; CHECK:       sw.bb1:
; CHECK-NEXT:    br label [[SW_BB]]
; CHECK:       sw.bb2:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 84, metadata [[META5]], metadata !DIExpression()), !dbg [[DBG7]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 84, [[META5]], !DIExpression(), [[DBG7]]
; CHECK-NEXT:    tail call void @abort()
; CHECK-NEXT:    unreachable
; CHECK:       sw.epilog:
; CHECK-NEXT:    ret void
