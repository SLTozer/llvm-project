...
; RUN: opt < %s -passes=debugify,simplifycfg -simplifycfg-require-and-preserve-domtree=1 -S | FileCheck --check-prefixes=DBGINFO,OLDDBG-DBGINFO %s
...
; RUN: opt < %s -passes=debugify,simplifycfg -simplifycfg-require-and-preserve-domtree=1 -S --try-experimental-debuginfo-iterators | FileCheck --check-prefixes=DBGINFO,NEWDBG-DBGINFO %s
...
; DBGINFO-LABEL: @test1(
; DBGINFO-NEXT:  entry:
; OLDDBG-DBGINFO-NEXT:    call void @llvm.dbg.value(metadata i32 0, metadata [[META9:![0-9]+]], metadata !DIExpression()), !dbg [[DBG11:![0-9]+]]
; NEWDBG-DBGINFO-NEXT:    #dbg_value { i32 0, [[META9:![0-9]+]], !DIExpression(), [[DBG11:![0-9]+]]
...
; OLDDBG-DBGINFO-NEXT:    call void @llvm.dbg.value(metadata i32 0, metadata [[META15:![0-9]+]], metadata !DIExpression()), !dbg [[DBG16:![0-9]+]]
; NEWDBG-DBGINFO-NEXT:    #dbg_value { i32 0, [[META15:![0-9]+]], !DIExpression(), [[DBG16:![0-9]+]]
...
; OLDDBG-DBGINFO-NEXT:    call void @llvm.dbg.value(metadata i32 [[R]], metadata [[META20:![0-9]+]], metadata !DIExpression()), !dbg [[DBG23]]
; NEWDBG-DBGINFO-NEXT:    #dbg_value { i32 [[R]], [[META20:![0-9]+]], !DIExpression(), [[DBG23]]
