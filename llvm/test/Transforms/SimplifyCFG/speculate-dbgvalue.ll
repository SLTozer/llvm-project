...
; RUN: opt < %s -S -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=1 | FileCheck %s -check-prefixes=CHECK,OLDDBG-CHECK
; RUN: opt < %s -S -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=1 --try-experimental-debuginfo-iterators | FileCheck %s -check-prefixes=CHECK,NEWDBG-CHECK
...
; CHECK-LABEL: @test1(
; CHECK-NEXT:  entry:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[GETDIRT:%.*]], metadata !12, metadata !DIExpression()), !dbg !15
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[DIRT:%.*]], metadata !13, metadata !DIExpression()), !dbg !16
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 100, metadata !14, metadata !DIExpression()), !dbg !17
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[GETDIRT:%.*]], !12, !DIExpression(), !15
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[DIRT:%.*]], !13, !DIExpression(), !16
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 100, !14, !DIExpression(), !17
...
; OLDDBG-CHECK-NOT:     call void @llvm.dbg.value(metadata i32 [[DIRT]], metadata !14
; NEWDBG-CHECK-NOT:     #dbg_value { i32 [[DIRT]], !14
; CHECK-NEXT:    [[RESULT:%.*]] = select i1 [[CMP]], i32 [[DIRT]], i32 100, !dbg !20
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[RESULT]], metadata !14, metadata !DIExpression()), !dbg !17
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[RESULT]], !14, !DIExpression(), !17
