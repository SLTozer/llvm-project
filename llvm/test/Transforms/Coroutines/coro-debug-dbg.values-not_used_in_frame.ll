...
; CHECK:       await.ready:
; OLDDBG-CHECK:         call void @llvm.dbg.value(metadata i32 poison, metadata ![[IVAR_RESUME:[0-9]+]], metadata !DIExpression(
; OLDDBG-CHECK:         call void @llvm.dbg.value(metadata i32 poison, metadata ![[JVAR_RESUME:[0-9]+]], metadata !DIExpression(
; NEWDBG-CHECK:         #dbg_value { i32 poison, ![[IVAR_RESUME:[0-9]+]], !DIExpression(
; NEWDBG-CHECK:         #dbg_value { i32 poison, ![[JVAR_RESUME:[0-9]+]], !DIExpression(
;
