; RUN: opt %s -S -o - -passes=loop-unroll | FileCheck %s -check-prefixes=OLDDBG-CHECK
; RUN: opt %s -S -o - -passes=loop-unroll --try-experimental-debuginfo-iterators | FileCheck %s -check-prefixes=NEWDBG-CHECK
...
for.body:                                         ; preds = %entry, %for.body
  ...
  ; OLDDBG-CHECK: call void @llvm.dbg.value(metadata i32 1, metadata !12, metadata !DIExpression()), !dbg !15
  ; OLDDBG-CHECK: call void @llvm.dbg.value(metadata i32 4, metadata !12, metadata !DIExpression()), !dbg !15
  ; OLDDBG-CHECK: call void @llvm.dbg.value(metadata i32 16, metadata !12, metadata !DIExpression()), !dbg !15
  ; OLDDBG-CHECK: call void @llvm.dbg.value(metadata i32 64, metadata !12, metadata !DIExpression()), !dbg !15
  ; NEWDBG-CHECK: #dbg_value { i32 1, !12, !DIExpression(), !15
  ; NEWDBG-CHECK: #dbg_value { i32 4, !12, !DIExpression(), !15
  ; NEWDBG-CHECK: #dbg_value { i32 16, !12, !DIExpression(), !15
  ; NEWDBG-CHECK: #dbg_value { i32 64, !12, !DIExpression(), !15
