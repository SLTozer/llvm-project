...
; OLDDBG-CHECK: call void @llvm.dbg.declare(metadata ptr %[[USP]], metadata ![[VAR_ARG:.*]], metadata !DIExpression(DW_OP_constu, 104, DW_OP_minus))
; OLDDBG-CHECK-NOT: call void @llvm.dbg.declare
; OLDDBG-CHECK: call void @llvm.dbg.declare(metadata ptr %[[USP]], metadata ![[VAR_LOCAL:.*]], metadata !DIExpression(DW_OP_constu, 208, DW_OP_minus))
; OLDDBG-CHECK-NOT: call void @llvm.dbg.declare
; NEWDBG-CHECK-NOT: #dbg_declare
; NEWDBG-CHECK: #dbg_declare { ptr %[[USP]], ![[VAR_ARG:.*]], !DIExpression(DW_OP_constu, 104, DW_OP_minus)
; NEWDBG-CHECK-NOT: #dbg_declare
; NEWDBG-CHECK: #dbg_declare { ptr %[[USP]], ![[VAR_LOCAL:.*]], !DIExpression(DW_OP_constu, 208, DW_OP_minus)
; NEWDBG-CHECK-NOT: #dbg_declare
