...
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[VLA1_0]], metadata [[META11:![0-9]+]], metadata !DIExpression()), !dbg [[DBG19:![0-9]+]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[VLA1_0]], [[META11:![0-9]+]], !DIExpression(), [[DBG19:![0-9]+]]
; CHECK-NEXT:    [[T0]] = add i32 [[VLA1_0]], 1
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[T0]], metadata [[META11]], metadata !DIExpression()), !dbg [[DBG19]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[T0]], [[META11]], !DIExpression(), [[DBG19]]
