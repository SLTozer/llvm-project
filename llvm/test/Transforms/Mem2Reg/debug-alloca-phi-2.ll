...
; OLDDBG-CHECK: call void @llvm.dbg.value(metadata i1 %[[PHI]],
; OLDDBG-CHECK-SAME:                      metadata !DIExpression())
; NEWDBG-CHECK: #dbg_value { i1 %[[PHI]],
; NEWDBG-CHECK-SAME:                      !DIExpression()
  %0 = add i1 %entryN, 1
; CHECK: %0 = add i1 %[[PHI]], true
; OLDDBG-CHECK: call void @llvm.dbg.value(metadata i1 %0,
; OLDDBG-CHECK-SAME:                      metadata !DIExpression())
; NEWDBG-CHECK: #dbg_value { i1 %0,
; NEWDBG-CHECK-SAME:                      !DIExpression()
  store i1 %0, ptr %entry1, align 8, !dbg !20
  br label %for.cond, !dbg !20
}
