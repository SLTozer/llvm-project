...
; OLDDBG-CHECK-NEXT:     call void @llvm.dbg.value(metadata i32 %a,{{.*}}, !dbg
; OLDDBG-CHECK-NEXT:     call void @llvm.dbg.value(metadata i32 %a,{{.*}}, !dbg
; OLDDBG-CHECK-NEXT:     call void @llvm.dbg.value(metadata i64 55,{{.*}}, !dbg
; OLDDBG-CHECK-NEXT:     call void @llvm.dbg.value(metadata ptr @baz,{{.*}}, !dbg
; NEWDBG-CHECK-NEXT:     #dbg_value { i32 %a,{{.*}}, 
; NEWDBG-CHECK-NEXT:     #dbg_value { i32 %a,{{.*}}, 
; NEWDBG-CHECK-NEXT:     #dbg_value { i64 55,{{.*}}, 
; NEWDBG-CHECK-NEXT:     #dbg_value { ptr @baz,{{.*}}, 
