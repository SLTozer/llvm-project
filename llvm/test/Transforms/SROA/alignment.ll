...
; RUN: opt -passes='debugify,function(sroa<preserve-cfg>)' -S < %s | FileCheck %s -check-prefixes CHECK-DEBUGLOC,OLDDBG-CHECK-DEBUGLOC
; RUN: opt -passes='debugify,function(sroa<preserve-cfg>)' -S < %s --try-experimental-debuginfo-iterators | FileCheck %s -check-prefixes CHECK-DEBUGLOC,NEWDBG-CHECK-DEBUGLOC
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META9:![0-9]+]], metadata !DIExpression()), !dbg [[DBG14:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META9:![0-9]+]], !DIExpression(), [[DBG14:![0-9]+]]
; CHECK-DEBUGLOC-NEXT:    [[GEP_A:%.*]] = getelementptr { i8, i8 }, ptr [[A:%.*]], i32 0, i32 0, !dbg [[DBG15:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr [[GEP_A]], metadata [[META11:![0-9]+]], metadata !DIExpression()), !dbg [[DBG15]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META12:![0-9]+]], metadata !DIExpression()), !dbg [[DBG16:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr [[GEP_A]], [[META11:![0-9]+]], !DIExpression(), [[DBG15]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META12:![0-9]+]], !DIExpression(), [[DBG16:![0-9]+]]
; CHECK-DEBUGLOC-NEXT:    [[GEP_B:%.*]] = getelementptr { i8, i8 }, ptr [[B:%.*]], i32 0, i32 0, !dbg [[DBG17:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr [[GEP_B]], metadata [[META13:![0-9]+]], metadata !DIExpression()), !dbg [[DBG17]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr [[GEP_B]], [[META13:![0-9]+]], !DIExpression(), [[DBG17]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META23:![0-9]+]], metadata !DIExpression()), !dbg [[DBG28]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META24:![0-9]+]], metadata !DIExpression()), !dbg [[DBG29:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META23:![0-9]+]], !DIExpression(), [[DBG28]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META24:![0-9]+]], !DIExpression(), [[DBG29:![0-9]+]]
; CHECK-DEBUGLOC-NEXT:    store volatile i16 0, ptr [[A_SROA_0]], align 2, !dbg [[DBG30:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META25:![0-9]+]], metadata !DIExpression()), !dbg [[DBG31:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META25:![0-9]+]], !DIExpression(), [[DBG31:![0-9]+]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata i8 [[A_SROA_0_1_A_SROA_0_2_RESULT]], metadata [[META26:![0-9]+]], metadata !DIExpression()), !dbg [[DBG32]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { i8 [[A_SROA_0_1_A_SROA_0_2_RESULT]], [[META26:![0-9]+]], !DIExpression(), [[DBG32]]
...
; CHECK-DEBUGLOC-NEXT:  entry:
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META37:![0-9]+]], metadata !DIExpression()), !dbg [[DBG38:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META37:![0-9]+]], !DIExpression(), [[DBG38:![0-9]+]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META44:![0-9]+]], metadata !DIExpression()), !dbg [[DBG47]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META44:![0-9]+]], !DIExpression(), [[DBG47]]
; CHECK-DEBUGLOC-NEXT:    [[B_SROA_0:%.*]] = alloca [18 x i8], align 2, !dbg [[DBG48:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META45:![0-9]+]], metadata !DIExpression()), !dbg [[DBG48]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META45:![0-9]+]], !DIExpression(), [[DBG48]]
; CHECK-DEBUGLOC-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 8 [[A_SROA_0]], ptr align 8 [[X:%.*]], i32 22, i1 false), !dbg [[DBG49:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META46:![0-9]+]], metadata !DIExpression()), !dbg [[DBG50:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META46:![0-9]+]], !DIExpression(), [[DBG50:![0-9]+]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META55:![0-9]+]], metadata !DIExpression()), !dbg [[DBG63]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META55:![0-9]+]], !DIExpression(), [[DBG63]]
; CHECK-DEBUGLOC-NEXT:    store volatile double 0.000000e+00, ptr [[A_SROA_0]], align 1, !dbg [[DBG64:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META56:![0-9]+]], metadata !DIExpression()), !dbg [[DBG65:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META56:![0-9]+]], !DIExpression(), [[DBG65:![0-9]+]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata i16 [[A_SROA_0_7_A_SROA_0_7_WEIRD_LOAD1]], metadata [[META57:![0-9]+]], metadata !DIExpression()), !dbg [[DBG66]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META59:![0-9]+]], metadata !DIExpression()), !dbg [[DBG67:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { i16 [[A_SROA_0_7_A_SROA_0_7_WEIRD_LOAD1]], [[META57:![0-9]+]], !DIExpression(), [[DBG66]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META59:![0-9]+]], !DIExpression(), [[DBG67:![0-9]+]]
; CHECK-DEBUGLOC-NEXT:    [[A_SROA_0_0_A_SROA_0_0_D1:%.*]] = load double, ptr [[A_SROA_0]], align 1, !dbg [[DBG68:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata double [[A_SROA_0_0_A_SROA_0_0_D1]], metadata [[META60:![0-9]+]], metadata !DIExpression()), !dbg [[DBG68]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { double [[A_SROA_0_0_A_SROA_0_0_D1]], [[META60:![0-9]+]], !DIExpression(), [[DBG68]]
; CHECK-DEBUGLOC-NEXT:    store volatile double [[A_SROA_0_0_A_SROA_0_0_D1]], ptr [[A_SROA_3]], align 1, !dbg [[DBG69:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META61:![0-9]+]], metadata !DIExpression()), !dbg [[DBG70:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META61:![0-9]+]], !DIExpression(), [[DBG70:![0-9]+]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata i16 [[A_SROA_3_7_A_SROA_3_16_WEIRD_LOAD2]], metadata [[META62:![0-9]+]], metadata !DIExpression()), !dbg [[DBG71]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { i16 [[A_SROA_3_7_A_SROA_3_16_WEIRD_LOAD2]], [[META62:![0-9]+]], !DIExpression(), [[DBG71]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META75:![0-9]+]], metadata !DIExpression()), !dbg [[DBG78]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META75:![0-9]+]], !DIExpression(), [[DBG78]]
; CHECK-DEBUGLOC-NEXT:    store volatile double 0.000000e+00, ptr [[A_SROA_0]], align 8, !dbg [[DBG79:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META76:![0-9]+]], metadata !DIExpression()), !dbg [[DBG80:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META76:![0-9]+]], !DIExpression(), [[DBG80:![0-9]+]]
; CHECK-DEBUGLOC-NEXT:    [[A_SROA_0_0_A_SROA_0_0_VAL:%.*]] = load double, ptr [[A_SROA_0]], align 8, !dbg [[DBG81:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata double [[A_SROA_0_0_A_SROA_0_0_VAL]], metadata [[META77:![0-9]+]], metadata !DIExpression()), !dbg [[DBG81]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { double [[A_SROA_0_0_A_SROA_0_0_VAL]], [[META77:![0-9]+]], !DIExpression(), [[DBG81]]
...
; CHECK-DEBUGLOC-NEXT:  entry:
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META86:![0-9]+]], metadata !DIExpression()), !dbg [[DBG90:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META87:![0-9]+]], metadata !DIExpression()), !dbg [[DBG91:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META86:![0-9]+]], !DIExpression(), [[DBG90:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META87:![0-9]+]], !DIExpression(), [[DBG91:![0-9]+]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata double [[A_SROA_4_0_COPYLOAD]], metadata [[META88:![0-9]+]], metadata !DIExpression()), !dbg [[DBG93:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata double [[A_SROA_0_0_COPYLOAD]], metadata [[META89:![0-9]+]], metadata !DIExpression()), !dbg [[DBG94:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { double [[A_SROA_4_0_COPYLOAD]], [[META88:![0-9]+]], !DIExpression(), [[DBG93:![0-9]+]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { double [[A_SROA_0_0_COPYLOAD]], [[META89:![0-9]+]], !DIExpression(), [[DBG94:![0-9]+]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr [[PTR]], metadata [[META99:![0-9]+]], metadata !DIExpression()), !dbg [[DBG102]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr [[PTR]], [[META99:![0-9]+]], !DIExpression(), [[DBG102]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata [5 x i32] [[VAL_FCA_4_INSERT]], metadata [[META100:![0-9]+]], metadata !DIExpression()), !dbg [[DBG104]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { [5 x i32] [[VAL_FCA_4_INSERT]], [[META100:![0-9]+]], !DIExpression(), [[DBG104]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr [[PTR]], metadata [[META108:![0-9]+]], metadata !DIExpression()), !dbg [[DBG110]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr [[PTR]], [[META108:![0-9]+]], !DIExpression(), [[DBG110]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata [5 x i32] [[VAL_FCA_4_INSERT]], metadata [[META109:![0-9]+]], metadata !DIExpression()), !dbg [[DBG112]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { [5 x i32] [[VAL_FCA_4_INSERT]], [[META109:![0-9]+]], !DIExpression(), [[DBG112]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr [[PTR]], metadata [[META116:![0-9]+]], metadata !DIExpression()), !dbg [[DBG119]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr [[PTR]], [[META116:![0-9]+]], !DIExpression(), [[DBG119]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata { i32, i8, i8, { i8, i16 } } [[VAL_FCA_3_1_INSERT]], metadata [[META117:![0-9]+]], metadata !DIExpression()), !dbg [[DBG121]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { { i32, i8, i8, { i8, i16 } } [[VAL_FCA_3_1_INSERT]], [[META117:![0-9]+]], !DIExpression(), [[DBG121]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META125:![0-9]+]], metadata !DIExpression()), !dbg [[DBG129]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { ptr undef, [[META125:![0-9]+]], !DIExpression(), [[DBG129]]
; CHECK-DEBUGLOC-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A:%.*]], align 4, !dbg [[DBG130:![0-9]+]]
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata i32 [[TMP1]], metadata [[META126:![0-9]+]], metadata !DIExpression()), !dbg [[DBG130]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { i32 [[TMP1]], [[META126:![0-9]+]], !DIExpression(), [[DBG130]]
...
; OLDDBG-CHECK-DEBUGLOC-NEXT:    call void @llvm.dbg.value(metadata i32 [[B_SROA_0_0_B_SROA_0_0_X]], metadata [[META128:![0-9]+]], metadata !DIExpression()), !dbg [[DBG132]]
; NEWDBG-CHECK-DEBUGLOC-NEXT:    #dbg_value { i32 [[B_SROA_0_0_B_SROA_0_0_X]], [[META128:![0-9]+]], !DIExpression(), [[DBG132]]
