...
; RUN: opt -S -passes=jump-threading %s -o - -S | FileCheck %s -check-prefixes=CHECK,OLDDBG-CHECK
; RUN: opt -S -passes=jump-threading %s -o - -S --try-experimental-debuginfo-iterators | FileCheck %s -check-prefixes=CHECK,NEWDBG-CHECK
...
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 0, metadata [[META13:![0-9]+]], metadata !DIExpression()), !dbg [[DBG14:![0-9]+]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 0, [[META13:![0-9]+]], !DIExpression(), [[DBG14:![0-9]+]]
...
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 0, metadata [[META13]], metadata !DIExpression()), !dbg [[DBG14]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 0, [[META13]], !DIExpression(), [[DBG14]]
