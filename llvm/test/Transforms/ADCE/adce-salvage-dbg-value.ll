...
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[B]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[B]]
; CHECK-NEXT:    call void @may_not_return(i32 [[B]])
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[B]], {{.*}}DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[B]], {{.*}}DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)
; CHECK-NEXT:    ret void
;
