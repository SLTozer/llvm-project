...
; CHECK:       bb3:
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.declare(metadata ptr [[TEXT]], metadata [[META16:![0-9]+]], metadata !DIExpression()), !dbg [[DBG24:![0-9]+]]
; NEWDBG-CHECK-NEXT:    #dbg_declare { ptr [[TEXT]], [[META16:![0-9]+]], !DIExpression(), [[DBG24:![0-9]+]]
