...
; OLDDBG-CHECK: dbg.value(metadata i32 42, metadata [[METADATA_IDX1:![0-9]+]], metadata !DIExpression())
; NEWDBG-CHECK: #dbg_value { i32 42, [[METADATA_IDX1:![0-9]+]], !DIExpression()
; CHECK-NEXT: store
...
; OLDDBG-CHECK: dbg.value(metadata i32 %0, metadata [[METADATA_IDX1]], metadata !DIExpression())
; NEWDBG-CHECK: #dbg_value { i32 %0, [[METADATA_IDX1]], !DIExpression()
...
; OLDDBG-CHECK: dbg.value(metadata ptr %d1, metadata [[METADATA_IDX1]], metadata !DIExpression(DW_OP_deref))
; NEWDBG-CHECK: #dbg_value { ptr %d1, [[METADATA_IDX1]], !DIExpression(DW_OP_deref)
