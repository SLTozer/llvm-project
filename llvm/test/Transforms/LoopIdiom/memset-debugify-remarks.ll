...
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i1 [[CMP3]], metadata [[META9:![0-9]+]], metadata !DIExpression()), !dbg [[DBG15]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i1 [[CMP3]], [[META9:![0-9]+]], !DIExpression(), [[DBG15]]
...
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata ptr [[PTR_ADDR_04]], metadata [[META11:![0-9]+]], metadata !DIExpression()), !dbg [[DBG19]]
; NEWDBG-CHECK-NEXT:    #dbg_value { ptr [[PTR_ADDR_04]], [[META11:![0-9]+]], !DIExpression(), [[DBG19]]
; CHECK-NEXT:    [[INCDEC_PTR]] = getelementptr inbounds i8, ptr [[PTR_ADDR_04]], i64 1, !dbg [[DBG20:![0-9]+]]
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata ptr [[INCDEC_PTR]], metadata [[META13:![0-9]+]], metadata !DIExpression()), !dbg [[DBG20]]
; NEWDBG-CHECK-NEXT:    #dbg_value { ptr [[INCDEC_PTR]], [[META13:![0-9]+]], !DIExpression(), [[DBG20]]
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq ptr [[INCDEC_PTR]], [[END]], !dbg [[DBG21:![0-9]+]]
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i1 [[CMP]], metadata [[META14:![0-9]+]], metadata !DIExpression()), !dbg [[DBG21]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i1 [[CMP]], [[META14:![0-9]+]], !DIExpression(), [[DBG21]]
