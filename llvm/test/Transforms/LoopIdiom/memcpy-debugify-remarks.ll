...
; RUN: opt -passes=debugify,loop-idiom,verify -pass-remarks=loop-idiom -pass-remarks-analysis=loop-idiom -pass-remarks-output=%t.yaml -verify-each -verify-dom-info -verify-loop-info  < %s -S 2>&1 | FileCheck %s -check-prefixes=CHECK,OLDDBG-CHECK
; RUN: FileCheck --input-file=%t.yaml %s --check-prefixes=YAML

; RUN: opt -passes=debugify,loop-idiom,verify -pass-remarks=loop-idiom -pass-remarks-analysis=loop-idiom -pass-remarks-output=%t.yaml -verify-each -verify-dom-info -verify-loop-info  < %s -S 2>&1 --try-experimental-debuginfo-iterators | FileCheck %s -check-prefixes=CHECK,NEWDBG-CHECK
; RUN: FileCheck --input-file=%t.yaml %s --check-prefixes=YAML
...
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i64 [[INDVAR]], metadata [[META9:![0-9]+]], metadata !DIExpression()), !dbg [[DBG20]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i64 [[INDVAR]], [[META9:![0-9]+]], !DIExpression(), [[DBG20]]
; CHECK-NEXT:    [[I_0_014:%.*]] = getelementptr i32, ptr [[BASE]], i64 [[INDVAR]], !dbg [[DBG21:![0-9]+]]
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata ptr [[I_0_014]], metadata [[META11:![0-9]+]], metadata !DIExpression()), !dbg [[DBG21]]
; NEWDBG-CHECK-NEXT:    #dbg_value { ptr [[I_0_014]], [[META11:![0-9]+]], !DIExpression(), [[DBG21]]
; CHECK-NEXT:    [[DESTI:%.*]] = getelementptr i32, ptr [[DEST]], i64 [[INDVAR]], !dbg [[DBG22:![0-9]+]]
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata ptr [[DESTI]], metadata [[META12:![0-9]+]], metadata !DIExpression()), !dbg [[DBG22]]
; NEWDBG-CHECK-NEXT:    #dbg_value { ptr [[DESTI]], [[META12:![0-9]+]], !DIExpression(), [[DBG22]]
; CHECK-NEXT:    [[V:%.*]] = load i32, ptr [[I_0_014]], align 1, !dbg [[DBG23:![0-9]+]]
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i32 [[V]], metadata [[META13:![0-9]+]], metadata !DIExpression()), !dbg [[DBG23]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i32 [[V]], [[META13:![0-9]+]], !DIExpression(), [[DBG23]]
; CHECK-NEXT:    [[INDVAR_NEXT]] = add i64 [[INDVAR]], 1, !dbg [[DBG24:![0-9]+]]
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i64 [[INDVAR_NEXT]], metadata [[META15:![0-9]+]], metadata !DIExpression()), !dbg [[DBG24]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i64 [[INDVAR_NEXT]], [[META15:![0-9]+]], !DIExpression(), [[DBG24]]
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i64 [[INDVAR_NEXT]], [[SIZE]], !dbg [[DBG25:![0-9]+]]
; OLDDBG-CHECK-NEXT:    call void @llvm.dbg.value(metadata i1 [[EXITCOND]], metadata [[META16:![0-9]+]], metadata !DIExpression()), !dbg [[DBG25]]
; NEWDBG-CHECK-NEXT:    #dbg_value { i1 [[EXITCOND]], [[META16:![0-9]+]], !DIExpression(), [[DBG25]]
