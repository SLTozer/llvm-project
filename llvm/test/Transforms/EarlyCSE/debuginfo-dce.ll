...
entry:
  %0 = call i64 @llvm.ctpop.i64(i64 0), !dbg !13
  %1 = inttoptr i64 %0 to ptr, !dbg !13
  call void @llvm.dbg.value(metadata ptr %1, i64 0, metadata !11, metadata !DIExpression()), !dbg !13
; CHECK: call void @llvm.dbg.value(metadata i64 0, metadata !11, metadata !DIExpression()), !dbg !13
  %call = call ptr (...) @baa(), !dbg !14
  %2 = ptrtoint ptr %call to i64, !dbg !15
  %3 = inttoptr i64 %2 to ptr, !dbg !15
  call void @llvm.dbg.value(metadata ptr %3, i64 0, metadata !11, metadata !DIExpression()), !dbg !13
  %tobool = icmp ne ptr %3, null, !dbg !16
...
if.end:                                           ; preds = %entry
  %4 = ptrtoint ptr %3 to i32, !dbg !20
...
!13 = !DILocation(line: 4, column: 8, scope: !6)
!14 = !DILocation(line: 5, column: 9, scope: !6)
!15 = !DILocation(line: 5, column: 7, scope: !6)
!16 = !DILocation(line: 7, column: 7, scope: !17)
!17 = distinct !DILexicalBlock(scope: !6, file: !1, line: 7, column: 6)
!18 = !DILocation(line: 7, column: 6, scope: !6)
!19 = !DILocation(line: 8, column: 5, scope: !17)
!20 = !DILocation(line: 10, column: 10, scope: !6)
