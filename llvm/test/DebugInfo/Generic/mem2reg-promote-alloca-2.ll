...
; CHECK-NEXT: entry:
; OLDDBG-CHECK-NEXT: call void @llvm.dbg.value(metadata i64 0, metadata ![[LOCAL:[0-9]+]], metadata !DIExpression())
; OLDDBG-CHECK-NOT: call void @llvm.dbg.value({{.*}}, metadata ![[LOCAL]]
; NEWDBG-CHECK-NEXT: #dbg_value { i64 0, ![[LOCAL:[0-9]+]], !DIExpression()
