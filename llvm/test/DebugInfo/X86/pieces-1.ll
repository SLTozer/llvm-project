...
entry:
  call void @llvm.dbg.value(metadata i64 %s.coerce0, metadata !20, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64)), !dbg !21
  call void @llvm.dbg.value(metadata i32 %s.coerce1, metadata !22, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 32)), !dbg !21
