...
_ZN1NIN1K1LELi0EE11getOrInsertIiEE1AIPS1_ET_.exit.i: ; preds = %if.then.i.i, %entry
  ...
  call void @llvm.dbg.value(metadata ptr %call4.i, metadata !7, metadata !DIExpression(DW_OP_stack_value, DW_OP_LLVM_fragment, 0, 32)), !dbg !12
  call void @llvm.dbg.value(metadata ptr %call4.i, metadata !7, metadata !DIExpression(DW_OP_plus_uconst, 4, DW_OP_stack_value, DW_OP_LLVM_fragment, 64, 32)), !dbg !12
