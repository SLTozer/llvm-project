...
entry:
  ...
  ; OLDDBG-CHECK: call void @llvm.dbg.value(metadata double 0.000000e+00,
  ; OLDDBG-CHECK-SAME:                      metadata ![[C:[^,]*]],
  ; OLDDBG-CHECK-SAME:                      metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64))
  ; NEWDBG-CHECK: #dbg_value { double 0.000000e+00,
  ; NEWDBG-CHECK-SAME:                      ![[C:[^,]*]],
  ; NEWDBG-CHECK-SAME:                      !DIExpression(DW_OP_LLVM_fragment, 0, 64)
  store double 0.000000e+00, ptr %c.imagp, align 8, !dbg !17
  ; OLDDBG-CHECK: call void @llvm.dbg.value(metadata double 0.000000e+00,
  ; OLDDBG-CHECK-SAME:                      metadata ![[C]],
  ; OLDDBG-CHECK-SAME:                      metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64))
  ; NEWDBG-CHECK: #dbg_value { double 0.000000e+00,
  ; NEWDBG-CHECK-SAME:                      ![[C]],
  ; NEWDBG-CHECK-SAME:                      !DIExpression(DW_OP_LLVM_fragment, 64, 64)
  ret void, !dbg !18
}
