...
entry:
  ...
  tail call void @llvm.dbg.value(metadata i32 %param1, i64 0, metadata !29, metadata !DIExpression()), !dbg !47
  tail call void @llvm.dbg.value(metadata i32 %param2, i64 0, metadata !30, metadata !DIExpression()), !dbg !48
  tail call void @llvm.dbg.value(metadata ptr null, i64 0, metadata !31, metadata !DIExpression()), !dbg !49
...
if.then:                                          ; preds = %entry
  ...
  tail call void @llvm.dbg.value(metadata ptr %call, i64 0, metadata !31, metadata !DIExpression()), !dbg !49
  br label %if.end, !dbg !55

if.end:                                           ; preds = %entry, %if.then
  call void @llvm.lifetime.start.p0(i64 4, ptr %var1) #4, !dbg !56
  tail call void @llvm.dbg.value(metadata ptr %var1, i64 0, metadata !32, metadata !DIExpression(DW_OP_deref)), !dbg !58
  tail call void @llvm.dbg.value(metadata ptr %var1, i64 0, metadata !36, metadata !DIExpression()), !dbg !59
  tail call void @llvm.dbg.value(metadata ptr @.str, i64 0, metadata !38, metadata !DIExpression()), !dbg !62
  call void @_Z3fooPcjPKc(ptr %var1, i32 4, ptr nonnull @.str), !dbg !63
  call void @llvm.lifetime.start.p0(i64 4, ptr %var2) #4, !dbg !65
  call void @llvm.dbg.value(metadata ptr %var2, i64 0, metadata !33, metadata !DIExpression(DW_OP_deref)), !dbg !66
  call void @llvm.dbg.value(metadata ptr %var2, i64 0, metadata !36, metadata !DIExpression()), !dbg !67
  call void @llvm.dbg.value(metadata ptr @.str, i64 0, metadata !38, metadata !DIExpression()), !dbg !69
  call void @_Z3fooPcjPKc(ptr %var2, i32 4, ptr nonnull @.str), !dbg !70
  %tobool1 = icmp eq i32 %param1, 0, !dbg !71
  call void @llvm.dbg.value(metadata ptr %var2, i64 0, metadata !33, metadata !DIExpression(DW_OP_deref)), !dbg !66
  call void @llvm.dbg.value(metadata ptr %var2, i64 0, metadata !41, metadata !DIExpression()), !dbg !73
  br i1 %tobool1, label %if.else, label %if.then2, !dbg !75

if.then2:                                         ; preds = %if.end
  call void @llvm.dbg.value(metadata ptr @.str.1, i64 0, metadata !42, metadata !DIExpression()), !dbg !76
  call void @_Z3fooPcjPKc(ptr %var2, i32 4, ptr nonnull @.str.1), !dbg !78
  br label %if.end3, !dbg !79

if.else:                                          ; preds = %if.end
  call void @llvm.dbg.value(metadata ptr @.str.2, i64 0, metadata !42, metadata !DIExpression()), !dbg !80
  call void @_Z3fooPcjPKc(ptr %var2, i32 4, ptr nonnull @.str.2), !dbg !81
  br label %if.end3

if.end3:                                          ; preds = %if.else, %if.then2
  call void @llvm.dbg.value(metadata ptr %var1, i64 0, metadata !32, metadata !DIExpression(DW_OP_deref)), !dbg !58
  call void @llvm.dbg.value(metadata ptr %var1, i64 0, metadata !41, metadata !DIExpression()), !dbg !82
  call void @llvm.dbg.value(metadata ptr @.str, i64 0, metadata !42, metadata !DIExpression()), !dbg !84
