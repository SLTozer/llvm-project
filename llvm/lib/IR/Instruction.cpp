...
InsertPosition::InsertPosition(Instruction *InsertBefore) : InsertAt(InsertBefore ? InsertBefore->getIterator() : InstListType::iterator()) {}
InsertPosition::InsertPosition(BasicBlock *InsertAtEnd) : InsertAt(InsertAtEnd ? InsertAtEnd->end() : InstListType::iterator()) {}
...
bool Instruction::comesBefore(const Instruction *Other) const {
  ...
  assert(getParent() == Other->getParent() && "cross-BB instruction order comparison");
